...
import { mapPointerToThreeJS, mapPalmToThreeJS, resetCameraPosition } from './draw.js'; // Import the function
        ...
        for (const landmarks of results.landmarks) {
            ...
            if (results.gestures.length > 0) {
                ...
                if (categoryName === "Pointing_Up") {
                    ...
                    // Map the coordinates to the Three.js canvas
                    mapPointerToThreeJS(x, y);
                }
            }
